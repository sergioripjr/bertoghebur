        ...
        <div id="tempCentral">      	
            ...
            <div id="tempConteudo" style="background-color:<?= $_SESSION['corFundoDivs'] ?>;">
                ...
                <div id="tempConteudoMenu">
					...
					include("tpl/003/busca.php"); #Busca 
					...
					include("lib/enquete/form_enquete.php"); #Enquete                       
					include("html/menu_lateral.html"); #HTMLusuario
                    ?>
                </div>
            ...
            <div id="tempRodape">
            	<div style="color:#<?= $_SESSION['corFonte'] ?>;"><?= nl2br($_SESSION['textoEndereco']) ?></div>
